...
names(kiosk_pairs1)[6:8] <- c('distance_miles', 'distance_seconds',
                              'mapdist_status')
# kiosk_pairs1$distance_miles <- map_dists1$distances
# kiosk_pairs1$distance_seconds <- map_dists1$time_sec
# kiosk_pairs1$mapdist_status <- map_dists1$status
saveRDS(kiosk_pairs1, './data/kiokiosk_pairs1_withdist.rds')
map_dists2 <- distance_calculations(kiosk_pairs2)
kiosk_pairs2$distance_miles <- map_dists2$distance_miles
kiosk_pairs2$distance_seconds <- map_dists2$distance_seconds
kiosk_pairs2$mapdist_status <- map_dists2$status
saveRDS(kiosk_pairs2, './data/kiokiosk_pairs2_withdist.rds')
map_dists3 <- distance_calculations(kiosk_pairs3)
kiosk_pairs3$distance_miles <- map_dists3$distance_miles
kiosk_pairs3$distance_seconds <- map_dists3$distance_seconds
kiosk_pairs3$mapdist_status <- map_dists3$status
